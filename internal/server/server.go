...
func (s *Server) installHandler() {
	...
	mux.HandleFunc("POST /v1/workspaces/{id}/ultraplan/respond", c.handlePostWorkspaceUltraplanRespond)
	mux.HandleFunc("POST /v1/workspaces/{id}/ultraplan/cancel", c.handlePostWorkspaceUltraplanCancel)
	mux.HandleFunc("POST /v1/workspaces/{id}/ultraplan/start", c.handlePostWorkspaceUltraplanStart)
	mux.HandleFunc("POST /v1/workspaces/{id}/ultraplan/abandon", c.handlePostWorkspaceUltraplanAbandon)
